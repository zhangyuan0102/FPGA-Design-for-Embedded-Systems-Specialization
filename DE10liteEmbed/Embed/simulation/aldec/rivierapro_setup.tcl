...
alias com {
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_avalon_st_adapter_005_error_adapter_0.sv"   -work error_adapter_0                    
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_avalon_st_adapter_005.v"                    -work avalon_st_adapter_005              
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                        -work rsp_mux                            
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_rsp_demux_009.sv"                           -work rsp_demux_009                      
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_rsp_demux_007.sv"                           -work rsp_demux_007                      
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_router_012.sv"                              -work router_012                         
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_router_010.sv"                              -work router_010                         
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_router_008.sv"                              -work router_008                         
