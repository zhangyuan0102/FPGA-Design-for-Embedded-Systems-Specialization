...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_avalon_st_adapter_005_error_adapter_0.sv"   -work error_adapter_0                    
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_avalon_st_adapter_005.v"                    -work avalon_st_adapter_005              
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_rsp_demux_007.sv"                           -work rsp_demux_007                      
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_router_008.sv"                              -work router_008                         
